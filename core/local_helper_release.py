...
def get_local_helper_release() -> dict:
    ...
    for architecture, url, digest in (
        ("arm64", config.LOCAL_WECHAT_HELPER_ARM64_URL, config.LOCAL_WECHAT_HELPER_ARM64_SHA256),
        ("x86_64", config.LOCAL_WECHAT_HELPER_X64_URL, config.LOCAL_WECHAT_HELPER_X64_SHA256),
    ):
