...
本项目仅供**学习、研究和个人回忆整理**等合法用途。

**使用者须知：**

1. **合法授权**：导入聊天记录前，你必须已获得聊天对象的**知情同意**，或有其他合法依据处理该数据。未经他人同意处理其个人信息可能违反《个人信息保护法》。
2. **禁止冒充**：严禁使用本工具生成的内容冒充他人进行欺诈、诈骗或其他违法活动。
3. **禁止伪造证据**：严禁将本工具生成的对话内容用作法律程序中的证据或用于误导他人。
4. **使用者责任**：本工具的开发者不对使用者的滥用行为承担任何责任。使用本工具即表示你理解并同意承担全部法律责任。

如发现本工具被用于违法行为，请向当地公安机关举报。
